...
namespace Jarvis.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260906075325_Phase9BApprovalRequestScope")]
    partial class Phase9BApprovalRequestScope
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jarvis.Domain.Tasks.TaskUserInputRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");

                    b.Property<long?>("AnsweredAtMs")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<bool>("RequestIdIsString")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("DeviceId", "ExecutionId", "RequestIdIsString", "RequestId")
                        .IsUnique();

                    b.ToTable("TaskUserInputRequests", (string)null);
                });
